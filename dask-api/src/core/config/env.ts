...
const envSchema = z.object({
  ...
  COMMUNICATION_CREDENTIAL_SECRET: z.string().min(32).optional(),
  AUTOMATION_EMAIL_SEND_MODE: z.enum(['mock', 'real']).default('mock'),
  AUTOMATION_EMAIL_PROVIDER: z.enum(['mock', 'resend']).default('mock'),
  AUTOMATION_WHATSAPP_SEND_MODE: z.enum(['mock', 'real']).default('mock'),
  AUTOMATION_WHATSAPP_PROVIDER: z.enum(['mock', 'meta']).default('mock'),
  META_WHATSAPP_ACCESS_TOKEN: z.string().optional(),
  META_WHATSAPP_PHONE_NUMBER_ID: z.string().optional(),
  META_WHATSAPP_GRAPH_API_VERSION: z.string().default('v23.0'),
  ...
  DOCUMENT_ASSET_STORAGE_DIR: z.string().default('data/document-assets'),
