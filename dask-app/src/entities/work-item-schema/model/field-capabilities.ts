...
export const fieldCapabilities: Record<WorkItemPublicFieldType, WorkItemFieldCapability> = {
  ...
  status: { selectable: true, arrayValue: false, computed: false, supportsOptions: true },
  priority: { selectable: true, arrayValue: false, computed: false, supportsOptions: true },
  ...
  attachment: { selectable: false, arrayValue: true, computed: false, supportsOptions: false },
  reference: { selectable: true, arrayValue: false, computed: false, supportsOptions: false },
  relation: { selectable: true, arrayValue: false, computed: false, supportsOptions: false },
  custom: { selectable: false, arrayValue: false, computed: false, supportsOptions: false },
  catalog_select: { selectable: true, arrayValue: false, computed: false, supportsOptions: true },
