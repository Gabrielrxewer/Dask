import type { BoardCommercialOperationalMetadata, Task } from "@/entities/task";
import type {
  CreateCustomerInput,
  Customer,
  CustomerStatus,
...
export interface CommercialListFilters extends CommercialWorkItemFilters {
  workItemType?: string;
}
...
export interface LinkCustomerToWorkItemInput {
  workItemId: string;
  fields: Record<string, unknown>;
  customFieldValues?: Record<string, unknown>;
}
...
export interface ConvertWorkItemToCustomerInput {
  workItemId: string;
  customerId?: string;
...
export interface CommercialOperationalContext {
  ...
  workItemTypeSlug: string | null;
  signalTypeSlug: string | null;
  initialWorkItemStateSlug: string | null;
  initialSignalStateSlug: string | null;
}

export interface CreateCustomerFromWorkItemInput {
  customer: CreateCustomerInput;
