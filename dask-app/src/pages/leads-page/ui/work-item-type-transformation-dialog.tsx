...
import { buildWorkItemTypeTransformationSchema, type WorkItemTypeTransformationValues } from "@/modules/leads/model";
...
export function WorkItemTypeTransformationDialog({
  ...
  return (
    <AppDialog
      ...
      title="Transformar Signal em Lead"
    ...
    >
      ...
      >
        <div className="leads-page__transformation-summary">
          <div>
            <span className="leads-page__eyebrow">WorkItem</span>
        ...
        {transformation.preservedFields.length > 0 ? (
          <div className="leads-page__transformation-preview">
            <span className="leads-page__eyebrow">Campos preservados</span>
            <div>
        ...
        {requiredFields.length > 0 ? (
          <AppFormGrid className="leads-page__form-grid" columns={2}>
